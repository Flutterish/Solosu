...
namespace osu.Game.Rulesets.Solosu.Replays {
	public class SolosuReplayFrame : ReplayFrame, IConvertibleReplayFrame {
		...
		public void FromLegacy ( LegacyReplayFrame currentFrame, IBeatmap beatmap, ReplayFrame lastFrame = null ) {
			...
			if ( currentFrame.MouseLeft1 ) Actions.Add( SolosuAction.Button1 );
			if ( currentFrame.MouseLeft2 ) Actions.Add( SolosuAction.Button2 );
		...
		public LegacyReplayFrame ToLegacy ( IBeatmap beatmap ) {
			...
			if ( Actions.Contains( SolosuAction.Button1 ) ) s |= ReplayButtonState.Left1;
			if ( Actions.Contains( SolosuAction.Button2 ) ) s |= ReplayButtonState.Left2;
